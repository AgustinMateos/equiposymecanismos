  ...
  return (
    <section id="soluciones">
      <div className="xl:h-[400px] lg:h-[690px] flex flex-col justify-center items-center w-full py-10 relative">
        ...
        <div className="flex flex-wrap justify-start lg:justify-center items-center lg:py-10 lg:w-[80%] max-w-[1440px] xl:gap-[20px] lg:gap-[10px] z-0 bg-[#60AFFF] rounded-md">
