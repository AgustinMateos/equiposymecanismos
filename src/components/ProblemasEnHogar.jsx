...
export default function ProblemasEnHogar({ items }) {
  return (
    <section
      id="mision"
      className="bg-[#60AFFF] flex flex-col justfiy-center items-center px-20 2xl:px-60 xl:px-40 py-24 text-[white]"
    >
      <h3 className="w-full text-center mb-5 2xl:mb-14 xl:mb-16 lg:mb-14 text-4xl text-black font-bold">
        Problemáticas comúnes
      </h3>
      <div className="w-full flex justify-center items-center gap-[50px] 2xl:gap-[20px] 2xl:w-[80%]">
        {items.map((item) => (
          <div
            key={item.id}
